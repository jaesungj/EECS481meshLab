...
**
** Created: Tue Nov 17 15:14:25 2015
...
public:
    ...
    void setupUi(QWidget *pickpointsDialog)
    {
        ...
        gridLayout_2->addLayout(horizontalLayout_3, 5, 0, 1, 2);
        ...
        gridLayout_2->addWidget(groupBox_2, 7, 0, 1, 2);
        ...
        gridLayout_2->addWidget(groupBox_3, 8, 0, 1, 2);
        ...
        gridLayout_2->addLayout(horizontalLayout_6, 6, 0, 1, 1);
