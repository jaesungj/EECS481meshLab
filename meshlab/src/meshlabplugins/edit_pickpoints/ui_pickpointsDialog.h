...
public:
    ...
    void setupUi(QWidget *pickpointsDialog)
    {
        ...
        gridLayout_2->addWidget(groupBox_3, 9, 0, 1, 2);
        ...
        gridLayout_2->addLayout(horizontalLayout_3, 6, 0, 1, 2);
        ...
        gridLayout_2->addWidget(pickedPointsTreeWidget, 2, 0, 1, 2);
        ...
        gridLayout_2->addWidget(groupBox_2, 8, 0, 1, 2);
