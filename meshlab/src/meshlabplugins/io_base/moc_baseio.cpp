...
**
** Created: Mon Nov 23 16:55:12 2015
...
void BaseMeshIOPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData BaseMeshIOPlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BaseMeshIOPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BaseMeshIOPlugin,
      qt_meta_data_BaseMeshIOPlugin, &staticMetaObjectExtraData }
};
