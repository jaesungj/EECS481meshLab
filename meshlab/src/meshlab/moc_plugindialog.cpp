...
static const char qt_meta_stringdata_PluginDialog[] = {
    "PluginDialog\0\0item,ncolumn\0"
    "displayInfo(QTreeWidgetItem*,int)\0"
};
...
void PluginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->displayInfo((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
