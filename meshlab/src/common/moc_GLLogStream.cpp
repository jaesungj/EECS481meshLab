...
**
** Created: Mon Nov 23 16:53:11 2015
...
static const char qt_meta_stringdata_GLLogStream[] = {
    "GLLogStream\0\0logUpdated()\0"
};
...
const QMetaObjectExtraData GLLogStream::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GLLogStream::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GLLogStream,
      qt_meta_data_GLLogStream, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GLLogStream::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GLLogStream))
